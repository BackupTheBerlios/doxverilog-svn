...
class_declaration : virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list SEM_TOK                                                                       {VerilogDocGen::parseClassHeader();}  class_item_list end_class	 {vbufreset();}			   
				  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list EXTEND_TOK extends_identifier SEM_TOK                                         {VerilogDocGen::parseClassHeader();}  class_item_list end_class    {vbufreset();}
				  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list EXTEND_TOK extends_identifier LBRACE_TOK list_of_arguments RBRACE_TOK SEM_TOK {VerilogDocGen::parseClassHeader();} class_item_list end_class     {vbufreset();}
				  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list EXTEND_TOK extends_identifier LBRACE_TOK list_of_arguments RBRACE_TOK SEM_TOK  {VerilogDocGen::parseClassHeader();} error end_class              {vbufreset();}
				  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list SEM_TOK  {vbufreset();} error end_class	 {vbufreset();}			   
				  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list SEM_TOK   end_class	                                                           {VerilogDocGen::parseClassHeader();vbufreset();}			   
				  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list EXTEND_TOK extends_identifier LBRACE_TOK list_of_arguments RBRACE_TOK SEM_TOK  {VerilogDocGen::parseClassHeader();} end_class  {vbufreset();}
                  | virti CLASS_TOK  xlifetime class_identifier xmodule_parameter_port_list EXTEND_TOK extends_identifier  SEM_TOK                                         {VerilogDocGen::parseClassHeader();} end_class  {vbufreset();}
...
virti : /*empty*/    {VerilogDocGen::bClassHeader=true;}
					 | VIRTUAL_TOK {VerilogDocGen::bClassHeader=true;VerilogDocGen::portType+="virtual";}
       ;				  
