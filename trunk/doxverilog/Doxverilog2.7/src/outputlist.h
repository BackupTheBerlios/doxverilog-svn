...
class OutputList : public OutputDocInterface
{
  public:
	...
	void writeLineNumber(const char *ref,const char *file,const char *anchor,
                         int lineNumber,bool li=false) 
    { forall(&OutputGenerator::writeLineNumber,ref,file,anchor,lineNumber,li); }
  ...
  private:
    ...
    FORALLPROTO5(const char *,const char *,const char *,int, bool);
